...
export class HeaderPresenter {
  ...
  async handleToggleNotif() {
    ...
    try {
      ...
      console.error(
        "Error getting service worker registration or subscription:",
        err,
      );
    ...
    if (!this.notifEnabled) {
      if (permission === "denied") {
        alert(
          "Anda telah menolak izin notifikasi. Mohon ubah di pengaturan browser Anda.",
        );
        return;
      }
      ...
      try {
        ...
        if (Notification.permission === "denied") {
          ...
          alert(
            "Gagal mengaktifkan notifikasi. Pastikan Anda online dan coba lagi.",
          );
        }
        this.notifEnabled = false;
